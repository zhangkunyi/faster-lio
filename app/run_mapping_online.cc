...
DEFINE_string(traj_log_dir, std::string(ROOT_DIR) + "Log", "dir of traj log file");
...
int main(int argc, char **argv) {
    ...
    LOG(INFO) << "Save trajectory to: " << FLAGS_traj_log_dir;
    laser_mapping->Savetrajectory(FLAGS_traj_log_dir);
